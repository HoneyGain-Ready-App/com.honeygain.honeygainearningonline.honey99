...
public class honeygaincase99_SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.honeygaincase99_splash);
    ...
    private void NextScreen() {
        ...
        hndler.postDelayed(new Runnable() {
            @Override
            public void run() {
                honeygaincase99_SplashActivity.this.startActivity(new Intent(honeygaincase99_SplashActivity.this, honeygaincase99_start_page.class));
            }
        }, 8000);
    ...
    void datafromlink() {
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                ...
                String dataUrl = "https://adstxt.dev/de53865e3a/ads.txt";
